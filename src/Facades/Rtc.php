 ...
 * @method static \Crdesign8\LaravelRtcCalculator\Rtc comId(string $id)
 * @method static \Crdesign8\LaravelRtcCalculator\Rtc addItem(\Crdesign8\LaravelRtcCalculator\DTOs\ItemDTO $item)
 * @method static \Crdesign8\LaravelRtcCalculator\Rtc addItems(array $itens)
 * @method static \Crdesign8\LaravelRtcCalculator\Data\CalculoResult calcular()
 * @method static \Crdesign8\LaravelRtcCalculator\Data\CalculoResult executarCalculo(\Crdesign8\LaravelRtcCalculator\DTOs\CalculoRequestDTO $dto)
 * @method static \Crdesign8\LaravelRtcCalculator\Data\CalculoResult calcularPorNfe(string $xmlNfe, array $rtcPorItem, string $versao = '1.0.0')
